      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-3 text-left items-stretch">
          {plans.map((plan) => (
            <div
              key={plan.name}
              className={`relative flex flex-col justify-between rounded-2xl p-8 bg-white dark:bg-zinc-900 transition-all ${
                plan.popular
            ...
            >
              ...
              <div className="mt-8">
                <a
                  href="/app"
                  className={`w-full inline-flex items-center justify-center rounded-lg px-4 py-2.5 text-xs font-semibold transition-all ${
                    plan.popular
